...
class And : public Compound {
    public:
        ...
        bool evaluate() override {
            return std::all_of(begin(expressions), end(expressions), [](Expression* e) { return e->evaluate(); });
        }
};
...
class Or : public Compound {
    public:
        ...
        bool evaluate() override {
            return std::any_of(begin(expressions), end(expressions), [](Expression* e) { return e->evaluate(); });
        }
};
